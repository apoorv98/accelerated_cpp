...
bool not_url_char(char c) {
  ...
  // that can appear in URL
  static const string url_ch = "~;/?:@=&$-_.+!*(),";

  // see whether c can appear in URL
  // and return the negative
...
string::const_iterator url_beg(string::const_iterator b,
  ...
  // i marks the start of separator
  iter i = b;

  while ((i = search(i, e, sep.begin(), sep.end())) != e) {
    // make sure the separator isn't at
    ...
    // the separator we found wasn't part of URL
